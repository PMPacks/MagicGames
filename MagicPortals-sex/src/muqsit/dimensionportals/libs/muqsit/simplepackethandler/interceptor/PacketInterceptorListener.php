...
namespace muqsit\dimensionportals\libs\muqsit\simplepackethandler\interceptor;

use Closure;
use muqsit\dimensionportals\libs\muqsit\simplepackethandler\utils\ClosureSignatureParser;
